			...
			if(Array.isArray(geoJsonFeature.properties.depths[i])) {
				...
				for(let depth of geoJsonFeature.properties.depths[i]){
					if(depth === null){
						...
						colors1.push(value2color(depth,depthInData.minvalue,depthInData.maxvalue));
						weights1.push(5);
					}
				}
				...
				if(geoJsonFeature.properties.depths[i] === null){
					...
					colors.push(value2color(geoJsonFeature.properties.depths[i],depthInData.minvalue,depthInData.maxvalue));
					weights.push(5);
				}
			}
		}
